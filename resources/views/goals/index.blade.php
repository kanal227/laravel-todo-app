...
@section('content')
  <div class="container h-100">
    ...
    <div class="d-flex mb-3">
      ...
      <a href="#" class="ms-4 link-dark text-decoretion-none" data-bs-toggle="modal"data-bs-target="#addTagModal">
        <div class="d-flex align-items-center">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end text-center"aria-labelledby="dropdownTodoMenuLink">
                      <li>
                        <form action="{{ route('goals.todos.update', [$goal, $todo]) }}" method_exists="post">
                          @csrf
                          @method('patch')
